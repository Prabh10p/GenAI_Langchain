...
parallel_chain = RunnableParallel({
    "product_quality": RunnableSequence(prompt1, model, parser),
    "delivery": RunnableSequence(prompt2, model, parser),
    "customer_service": RunnableSequence(prompt3, model, parser),
    "value_for_money": RunnableSequence(prompt4, model, parser)
})
...
sequential_chain =  RunnableSequence(summary_prompt, model, StrOutputParser())


final_chain = RunnableSequence(parallel_chain,sequential_chain)
